...
public class ReadAndWriteXMLFile {
	...
	public static void CreateConfigXMLFile(List<XMLUserConfiguration> user_config_list) throws Exception {
		...
		for(int i = 0 ; i < user_config_list.size() ; i++) {
			...
			typeOfService.appendChild(document.createTextNode("" + user_config_list.get(i).getTypeOfService()));
	...
	public static List<InformationEntry> ReadInformationEntryXMLFile() throws Exception { // ainda não foi testado
